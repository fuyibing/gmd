...
func (o *memory) Reload() (err error) {
	for _, call := range []func() error{o.loadRegistry, o.loadTask} {
		if err = call(); err != nil {
			return
		}
	}
...
func (o *memory) loadRegistry() (err error) {
	var list []*models.Registry

	// List all registry
	// from database.
	if list, err = services.NewRegistryService().ListAll(); err != nil {
		return
	}
...
func (o *memory) loadTask() (err error) {
	var list []*models.Task

	// List enable tasks
	// from database.
	if list, err = services.NewTaskService().ListEnables(); err != nil {
		return
	}
