module github.com/fuyibing/gmd
...
require (
	...
	github.com/fuyibing/db/v3 v3.0.1
	github.com/fuyibing/log/v3 v3.0.4
	github.com/fuyibing/util/v2 v2.0.9
...
require (
	...
	github.com/fuyibing/gdoc v0.2.7 // indirect
